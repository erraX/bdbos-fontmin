...
exports.trimEnd = function (target) {
...
exports.trimStart = function (target) {
    if (!exports.isString(target)) {
        return;
    }

    return target[0] === '/'
            ? target.slice(1, target.length)
            : target;
};

exports.urlJoin = function (a, b) {
    var args = [].slice.call(arguments);

    return args.slice(1).reduce(function (result, str) {
        return exports.trimEnd(result, '/') + '/' + exports.trimStart(str, '/');
    }, args[0]);
};
